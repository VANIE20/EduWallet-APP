...
export default function ExpenseScreen() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setDialog({
      ...
      message: `Log ${formatCurrency(parsedAmount)} via ${selMethod.label} to ${accountNo}?`,
        ...
        try {
          ...
          if (!success) {
            ...
            setDialog({
              ...
              message: 'This expense would exceed your daily spending limit set by your guardian.',
              confirmLabel: 'OK',
            });
            return;
          }
          ...
          setDialog({
            ...
            message: `${formatCurrency(parsedAmount)} has been recorded. Payout via ${selMethod.label} to ${accountNo} will be processed by your school.`,
            confirmLabel: 'Done',
