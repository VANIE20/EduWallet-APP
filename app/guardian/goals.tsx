    ...
    <View style={styles.goalCard}>
      <View style={styles.goalHeader}>
        <View style={[styles.goalIconCircle, { backgroundColor: isComplete ? '#DCFCE7' : '#E0E7FF' }]}>
          <Ionicons
            ...
            size={24}
            color={isComplete ? '#16A34A' : '#9B1C1C'}
          />
        </View>
      ...
      <View style={styles.progressBarBg}>
        <View style={[styles.progressBarFill, {
          ...
          backgroundColor: isComplete ? '#16A34A' : '#9B1C1C',
        }]} />
      </View>

      <View style={styles.goalFooter}>
        <Text style={[styles.goalPercent, { color: isComplete ? '#16A34A' : '#9B1C1C' }]}>
        ...
        {!isComplete && (
          ...
          >
            <Ionicons name="add" size={18} color="#9B1C1C" />
          ...
          <Pressable style={styles.modalContent} onPress={(e) => e.stopPropagation()}>
            ...
            <View style={styles.modalActions}>
              ...
              <Pressable
                ...
                disabled={isSaving || !parseFloat(contributeAmount) || parseFloat(contributeAmount) > studentBalance}
                style={[styles.modalBtn, styles.modalBtnSave, (isSaving || !parseFloat(contributeAmount) || parseFloat(contributeAmount) > studentBalance) && { opacity: 0.4 }]}
              >
                <Text style={styles.modalBtnSaveText}>{isSaving ? 'Saving...' : 'Save'}</Text>
              </Pressable>
            </View>
          </Pressable>
        </Pressable>
